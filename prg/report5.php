...
$classname=trim($_GET['classname']);
 $heading = "Class wise Balances as on ". date("d-m-Y") . "\nClass :" .$classname;

 function fetch_data($classname1 )  
 {    
 //$start = date("Y-m-d", strtotime($start));
      $output = ''; 
	   
      include "dbconn.php";
      $sql = "SELECT * FROM `student` where balance!=0 && class_name='$classname1' ";
