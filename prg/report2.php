<?php  
 ob_start();
 session_start() ;
$schoolname = $_SESSION['schoolname'].$_SESSION['email'];
    ...
    $result = mysqli_query($conn, $sql);  
      ...
      $output .= '<tr>  
                         <td width="5%">' . $co . '</td>  
						  ...
						  <td align="left" width="15%">'.$row["class_name"].'</td>  
						   <td width="15%">'.$row["paid"].'</td>  
                     </tr> ';
...
$pdf->AddPage(A4);
	 ...
	 <table border="1" cellspacing="1" cellpadding="2">  
		   ...
		   <tr style="background-color:#e9ebe1;color:Black;font-size:11;">
                ...
                <th align="right" width="15%">Paid Amt.</th>  
           </tr> </thead>
    ...
    // $content  .= '<tbody>' ; 
     ...
     $content .= '</table>' ; 
	  //$heading = '<font size="14" color="red"> Collection from  ' ;
	   ...
	   //$pdf->writeHTML($content,true,true,false,false,'C') ;
 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center">Export HTML Table </h3><br />  
