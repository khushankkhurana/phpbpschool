...
$res17 =$Result1['address_1'];
$res18 =$Result1['address_2'];
$res19 =$Result1['city'];
$res = Array($res1,$res2,$res3,$res4,$res5,$res6,$res7,$res8,$res9,$res10,$res11,$res12,$res13,$res14,$res15,$res16,$res17,$res18,$res19);
//  echo $res ;
